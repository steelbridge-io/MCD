        ...
        <div class="container">
            ...
            <div class="eight columns">
                <div class="contact-form">
                    ...
                    if(is_plugin_active('contact-form-7/wp-contact-form-7.php') && isset($scrn['contactform7']) && $scrn['contactform7'] != '') { 
                        ...
                        <div class="done">
                            <?php _e('<b>Thank you!</b> I have received your message and will get back to you within 24 hours.', 'SCRN');?> 
                        </div>
            ...
            <div class="eight columns">
                ...
                <div class="contact-info">
					...
					<?php echo ('<img class="contact-logo" src="http://www.mccauslandconstruction.com/wp-content/themes/Big-Screen/images/mcd-logo-contact.png">');?>
                   ...
                   <!-- <?php //if(isset($scrn['email']) && $scrn['email'] != '') { ?><p class="white"><img src="<?php
                       // echo get_template_directory_uri();?>/images/icn-email.png" alt="" /> <a href="mailto:<?php
                       // echo $scrn['email'];?>"><?php //echo encEmail($scrn['email']);?></a></p><?php //} ?> -->
            ...
            <?php echo ('
				...
				<div class="mcd-logo-sprite-cont">
				<a href="#intro"><div class="mcd-logo-sprite"></div></a>
				</div>') ?>
